...
# 3. Local package setup
PACKAGE_ROOT = Path(__file__).resolve().parent.parent
sys.path.append(str(PACKAGE_ROOT))

# 4. Local modules
_datafun_toolkit_logger = importlib.import_module("datafun_toolkit.logger")
get_logger = _datafun_toolkit_logger.get_logger
log_header = _datafun_toolkit_logger.log_header

# === LOGGER CONFIGURATION ===
LOG: logging.Logger = get_logger("MOS", level="INFO")

# === GLOBAL CONSTANTS ===
ROOT_DIR: Final[Path] = Path.cwd()
DATA_DIR: Final[Path] = ROOT_DIR / "data"
PROCESSED_DIR: Final[Path] = DATA_DIR / "processed"
MOS_REPORT_DIR: Final[Path] = PROCESSED_DIR / "mos_reports"

# === DATASET ===
MOS_DATA: Final[list[dict]] = [
    {
        "mos": "92F",
    ...
    },
    {
        ...
        "civilian_jobs": ["IT Support", "Systems Technician", "Help Desk Analyst"],
        "avg_salary": 62000,
    ...
    },
    {
        ...
        "civilian_jobs": ["Medical Assistant", "EMT", "Patient Care Technician"],
        "avg_salary": 45000,
...
def generate_salary_chart() -> None:
    ...
    LOG.info(f"Wrote chart: {chart_path.name}")
